# from oop_and_patterns.week04.for_week04_02 import *
import random
...
def create_lever(level):
    level_map, level_objects = level.get_map(), level.get_objects()

    return level_map, level_objects


if __name__ == '__main__':
    level_map, level_objects = create_lever(EasyLevel)
    print(level_map._map)
    print()
    print(level_objects.objects)
