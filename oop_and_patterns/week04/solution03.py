            ...
            for i in range(5):
                for j in range(5):
                    if i == 0 or j == 0 or i == 4 or j == 4:
                        ...
                        self.Map[j][i] = random.randint(0,
                                                        2)  # СЃР»СѓС‡Р°Р№РЅР°СЏ С…Р°СЂР°РєС‚РµСЂРёСЃС‚РёРєР° РѕР±Р»Р°СЃС‚Рё
            ...
            for i in range(10):
                for j in range(10):
                    if i == 0 or j == 0 or i == 9 or j == 9:
                        self.Map[j][
                            i] = -1  # РіСЂР°РЅРёС†Р° РєР°СЂС‚С‹ :: РЅРµРїСЂРѕС…РѕРґРёРјС‹Р№ СѓС‡Р°СЃС‚РѕРє РєР°СЂС‚С‹
                    else:
                        self.Map[j][i] = random.randint(-1,
                                                        8)  # СЃР»СѓС‡Р°Р№РЅР°СЏ С…Р°СЂР°РєС‚РµСЂРёСЃС‚РёРєР° РѕР±Р»Р°СЃС‚Рё
